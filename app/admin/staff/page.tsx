    ...
    <div className="max-w-7xl mx-auto p-4 md:p-8">
      ...
      {employees?.length === 0 ? (
        <SpotlightCard className="text-center py-20 border-dashed border-slate-700">
          ...
          {!query && (
            <Link href="/admin/staff/create" className="text-blue-400 font-bold hover:text-blue-300">
          ...
          {employees?.map((emp) => (
            <SpotlightCard key={emp.id} className="flex flex-col gap-4 p-6 group">
              ...
              <div className="flex justify-between items-start">
                <div className="w-12 h-12 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-xl font-bold text-slate-400 group-hover:text-white group-hover:bg-blue-600 group-hover:border-blue-500 transition-all">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-bold text-white mb-1 group-hover:text-blue-400 transition-colors">{emp.name}</h3>
