            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-20 mb-16 relative z-10">
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-4 text-sm md:text-base">
                        ...
                        <Link href="/faq" className="text-slate-400 hover:text-[#D4AF37] transition-colors">
                            FAQ
                        </Link>
                        <Link href="/dress-code" className="text-slate-400 hover:text-[#D4AF37] transition-colors">
                            Dress Code
                        </Link>
                        <Link href="/privacy" className="text-slate-400 hover:text-[#D4AF37] transition-colors">
                            Privacy Policy
                        </Link>
                        <Link href="/terms" className="text-slate-400 hover:text-[#D4AF37] transition-colors">
                            Terms & Conditions
                        </Link>
                    </div>
                </div>
